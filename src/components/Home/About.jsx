  ...
  return (
    ...
    <div className='flex w-[80%] lg:w-[90%] sm:flex-col mx-auto mt-40 sm:mt-16 gap-16 lg:gap-5'>
       ...
       <Text>
            ...
            <p className=' mt-5'>Dear Visitors,</p>
            <p className=' mt-5'>Welcome to Samdenkens. We are thrilled to have you here, whether you are a valued partner, client, regulator, team member, or potential energy consumer. Our vision, <b>Safely Redefining Global Energy Services with Excellence, Integrity, and Unrivaled Innovation</b>, guides everything we do.</p>
<p className=' mt-5'>
...
<p className=' mt-5'>Warm regards,</p>
