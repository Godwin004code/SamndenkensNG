            ...
            <section className='mt-10 flex hidden  sm:flex-col gap-10'>
                <div className='p-8 flex w-full gap-3 rounded-[20px]' style={{ border: "1px solid #E5E5E5" }}>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex sm:justify-between sm:w-full xs:gap-0 gap-14 mt-2'>
                            <h2 className='font-medium sm:text-base text-xl'>OTC <br />  </h2>
                ...
                <div className='p-8 flex w-full gap-3 rounded-[20px]' style={{ border: "1px solid #E5E5E5" }}>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex sm:justify-between xs:w-full xs:gap-0 gap-14 mt-2'>
                            <h2 className='font-medium sm:text-base text-xl'>ADIPEC <br />  </h2>
                ...
                <div className='p-8 flex w-full gap-3 rounded-[20px]' style={{ border: "1px solid #E5E5E5" }}>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex sm:justify-between xs:w-full xs:gap-0 gap-14 mt-2'>
                            <h2 className='font-medium sm:text-base text-xl'>NOG <br />  </h2>
                ...
                <div className='p-8 flex w-full gap-3 rounded-[20px]' style={{ border: "1px solid #E5E5E5" }}>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex sm:justify-between xs:w-full xs:gap-0 gap-14 mt-2'>
                            <h2 className='font-medium sm:text-base text-xl'>GASTECH <br />  </h2>
